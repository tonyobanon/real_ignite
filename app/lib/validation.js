...
let InvalidParamError = createError('InvalidParamError', { code: 'INVALID_PARAMS' });
let InvalidContentTypeError = createError('InvalidContentType', { code: 'INVALID_CONTENT_TYPE' });
