...
module.exports = {
    ...
    JwtTokenIssuerMismatch: create('JwtTokenIssuerMismatch', {
        code: 'JWT_TOKEN_ISSUER_MISMATCH',
        defaultMessage: constants.message.JWT_TOKEN_ISSUER_MISMATCH
    }),

    UnableToGenerateJwt: create('UnableToGenerateJwt', {
        code: 'UNABLE_TO_GENERATE_JWT',
    ...
    MethodNotAllowedError: create('MethodNotAllowed', {
        code: 'METHOD_NOT_ALLOWED',
        defaultMessage: constants.message.METHOD_NOT_ALLOWED
    }),

    VersionNotAllowedError: create('VersionNotAllowed', {
    ...
    InvalidCredentialsError: create('InvalidCredentialsError', {
        code: 'INVALID_CREDENTIALS',
        defaultMessage: constants.message.INVALID_CREDENTIALS
    }),

    InvalidStringFormat: create('InvalidStringFormat', {
        code: 'INVALID_STRING_FORMAT',
        defaultMessage: constants.message.INVALID_STRING_FORMAT
    }),

    IssuerPrivateKeyNotFound: create('IssuerPrivateKeyNotFound', {
        code: 'ISSUER_PRIVATE_KEY_NOT_FOUND',
        defaultMessage: constants.message.ISSUER_PRIVATE_KEY_NOT_FOUND
    }),

    IssuerPublicKeyNotFound: create('IssuerPublicKeyNotFound', {
        code: 'ISSUER_PUBLIC_KEY_NOT_FOUND',
        defaultMessage: constants.message.ISSUER_PUBLIC_KEY_NOT_FOUND
    }),

    InvalidSession: create('InvalidSession', {
        code: 'INVALID_SESSION',
        defaultMessage: constants.message.INVALID_SESSION
    }),

    InvalidDraftMessage: create('InvalidDraftMessage', {
        code: 'INVALID_DRAFT_MESSAGE',
        defaultMessage: constants.message.INVALID_DRAFT_MESSAGE
    })
